    ...
    <footer className="bg-textPrimary text-white">
      <div className="container py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <p className="text-2xl font-serif">Isabel Ortuño</p>
            <p className="mt-2 text-white/60">Psicóloga Clínica</p>
          </motion.div>
          ...
          >
            <p>
              &copy; {currentYear} Gabinete de Psicología Isabel Ortuño. Todos los
              derechos reservados.
            </p>
            <p className="mt-2">
              Diseñado por{" "}
